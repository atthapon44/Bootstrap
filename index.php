...
<body>
    <div class="container">
    <img src="dFQROr7oWzulq5FZWgs0vW0XsqogKnZCqWUKSzlokBa7s1x9b3Tl8ELuZ6VkiBrSSDP.jpg"
    ...
    <div class="col-12 bg3">[Float:left]</div>
        ...
        <div class="row">
            <div class="col-4">
                ...
                <img src="คองค้อ-1.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
            ...
            <div class="col-4">
                <div class="card" style="width: 20rem;">
                    <img src="tiger-head-3244048_960_720.jpg" class="card-img-top" alt="...">
                    <div class="card-body">
